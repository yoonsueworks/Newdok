export const faqList = [
  ...
  },
  {
    ...
    question: "아티클이 뭔가요?",
    answer: [
      "아티클은 각 뉴스레터 브랜드가 정해진 날짜에 발행하는 수신물들을 의미해요. 뉴스레터가 수신하는 아티클들은 [홈] 화면에서 날짜별로 모아볼 수 있어요.",
    ],
  },
  ...
  },
  {
    ...
    answer: [
      "구독 확인이 필요한 경우 - [구독하기] 버튼을 눌러 구독을 신청하면 구독 상태가 [구독 확인 중]으로 변경되고, 구독 확인 메일이 발송돼요. 메일 본문에 삽입된 [구독 확인] 버튼을 눌러 구독 신청을 확인하고 첫 아티클을 수신받으면, 마이페이지 탭의 [구독 리스트]에서 구독이 완료된 것을 확인할 수 있습니다.",
      "구독 확인이 필요없는 경우 - [구독하기] 버튼을 눌러 구독을 신청하고 첫 아티클을 수신 받으면, 마이페이지 탭의 [구독 리스트]에서 구독이 완료된 것을 확인할 수 있습니다.",
    ],
  },
