...
const Received = () => {
  ...
  return (
    <div className="flex justify-center w-full h-full px-5 bg-neutralgray-200 overflow-scroll">
      <div className="flex flex-col w-full h-full sm:w-full md:w-full xl:px-28 bg-neutralgray-200 overflow-scroll">
