    ...
    <div className="sticky top-0 xl:pt-6 xl:px-[34px] bg-neutralgray-50">
      <div className="w-full h-fit flex xl:flex-row flex-col xl:gap-x-3 relative">
        <div className="grid gap-y-5 w-full">
          <div className="flex xl:flex-row gap-x-5 w-full">
            <div className="h-[264px] xl:h-80 w-full mb-36 xs:mb-48 sm:mb-52 xl:mb-0 flex-shrink-0 relative flex justify-center items-center">
              <div className="flex gap-y-4 z-50 block xl:hidden">
        ...
        <div className="xs:absolute sm:absolute md:absolute w-full top-60 gap-y-4 xl:flex xl:flex-col">
          <div className="flex justify-between rounded-xl px-6 py-5 elevation-2-bottom bg-white/[0.6] z-10 backdrop-blur-sm">
            <div>
              {brandName}
          ...
          <div className="xl:h-full xs:mt-4 sm:mt-4 md:mt-4 text-neutralgray-700 body-s xl:rounded-xl xl:bg-white/[0.6] xl:py-5 xl:px-6 md:pr-8 sm:px-5 xs:px-5 xl:flex xl:flex-col xl:justify-between xl:elevation-2-bottom">
      ...
      <div className="text-neutralgray-700 title-s w-full pb-2 xl:mt-10">
        지난 아티클 보기
      </div>
    </div>
  );
